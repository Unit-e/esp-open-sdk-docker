...
RUN mkdir -p /home/build/esp8266 && \
...
RUN cd /home/build/esp8266 && git clone https://github.com/espressif/ESP8266_NONOS_SDK --recurse-submodules
...
ENV PATH="/home/build/esp8266/xtensa-lx106-elf/bin:${PATH}"